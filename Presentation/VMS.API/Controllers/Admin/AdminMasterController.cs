...
namespace VMS.API.Controllers.Admin
{
    ...
    public class AdminMasterController : CustomBaseController
    {
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveTransporterType(TransporterType_Request parameters)
        {
            int result = await _adminMasterRepository.SaveTransporterType(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetTransporterTypeList(BaseSearchEntity parameters)
        {
            IEnumerable<TransporterType_Response> lstRoles = await _adminMasterRepository.GetTransporterTypeList(parameters);
            _response.Data = lstRoles.ToList();
            _response.Total = parameters.Total;
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetTransporterTypeById(int Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
            ...
            {
                var vResultObj = await _adminMasterRepository.GetTransporterTypeById(Id);
                _response.Data = vResultObj;
            }
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveBuildingName(BuildingName_Request parameters)
        {
            int result = await _adminMasterRepository.SaveBuildingName(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetBuildingNameList(BaseSearchEntity parameters)
        {
            IEnumerable<BuildingName_Response> lstRoles = await _adminMasterRepository.GetBuildingNameList(parameters);
            _response.Data = lstRoles.ToList();
            _response.Total = parameters.Total;
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetBuildingNameById(int Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
            ...
            {
                var vResultObj = await _adminMasterRepository.GetBuildingNameById(Id);
                _response.Data = vResultObj;
            }
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveBuildingRoomNumber(BuildingRoomNumber_Request parameters)
        {
            int result = await _adminMasterRepository.SaveBuildingRoomNumber(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetBuildingRoomNumberById(int Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
            ...
            {
                var vResultObj = await _adminMasterRepository.GetBuildingRoomNumberById(Id);
                _response.Data = vResultObj;
            }
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> SaveItem(Item_Request parameters)
        {
            int result = await _adminMasterRepository.SaveItem(parameters);
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetItemList(BaseSearchEntity parameters)
        {
            IEnumerable<Item_Response> lstRoles = await _adminMasterRepository.GetItemList(parameters);
            _response.Data = lstRoles.ToList();
            _response.Total = parameters.Total;
            return _response;
        }
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetItemById(int Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetMaterialTypeList(BaseSearchEntity parameters)
        {
        ...
        [Route("[action]")]
        [HttpPost]
        public async Task<ResponseModel> GetMaterialTypeById(int Id)
        {
            if (Id <= 0)
            {
                _response.Message = "Id is required";
