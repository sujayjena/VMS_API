...
namespace VMS.Persistence.Repositories
{
    public class ManageVisitorCompanyRepository : GenericRepository, IManageVisitorCompanyRepository
    {
        ...
        public async Task<IEnumerable<VisitorCompany_ImportDataValidation>> ImportVisitorCompany(List<VisitorCompany_ImportData> parameters)
        {
            DynamicParameters queryParameters = new DynamicParameters();
            ...
            return await ListByStoredProcedure<VisitorCompany_ImportDataValidation>("ImportVisitorCompany", queryParameters);
        }
    }
}
